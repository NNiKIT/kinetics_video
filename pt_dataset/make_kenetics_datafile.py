...
def make_classToindex(root_path):
    label = 0
    class_to_index = {}
    train_path = os.path.join(root_path, 'kinetics700-2020_train')
...
def make_data_file(root_path, split):
    ...
    split_path = os.path.join(root_path, 'kinetics700-2020_'+split)
...
if __name__ == '__main__':
    make_data_file('./videos_dataset/Kinetics/kinetics_700-2020_jpgs', 'train')
    make_data_file('./videos_dataset/Kinetics/kinetics_700-2020_jpgs', 'val')
